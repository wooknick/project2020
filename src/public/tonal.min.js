// thank you to https://github.com/danigb/tonal
...
!(function(n, t) {
  ...
  function r(n, t) {
    return (
      (n = Math.round(n)), (!0 === t ? I : T)[n % 12] + (Math.floor(n / 12) - 1)
    );
  }
  function e(n, t) {
    for (var r = []; t--; r[t] = t + n);
  ...
  function h(n, t) {
    ...
    var m =
      1 === r.length
        ? [e[0] - r[0], -Math.floor((7 * (e[0] - r[0])) / 12)]
        : [e[0] - r[0], e[1] - r[1]];
    return Dn(Wn(m));
  }
  function v(n, t) {
    ...
    var r = L(n),
      e = L(t);
    return null !== r.midi && null !== e.midi
      ? e.midi - r.midi
      : null !== r.chroma && null !== e.chroma
      ? (e.chroma - r.chroma + 12) % 12
      : null;
  }
  function A(n) {
    if (y(n)) return n;
  ...
  var F = "C C# Db D D# Eb E F F# Gb G G# Ab A A# Bb B".split(" "),
    G = function(n) {
    ...
    L = (function(n, t) {
      ...
      var e = r[0],
        m = r[1],
        i = r[2],
        u = { letter: e, acc: m, octStr: i };
      return (
        (u.pc = u.letter + u.acc),
        (u.name = u.pc + i),
        (u.step = (u.letter.charCodeAt(0) + 3) % 7),
        (u.alt = "b" === u.acc[0] ? -u.acc.length : u.acc.length),
        (u.oct = i.length ? +i : null),
        (u.chroma = (N[u.step] + u.alt + 120) % 12),
        (u.midi = null !== u.oct ? N[u.step] + u.alt + 12 * (u.oct + 1) : null),
        (u.freq = J(u.midi)),
        Object.freeze(u)
      );
    }),
    ...
    J = function(n, t) {
      return (
        void 0 === t && (t = 440),
        "number" == typeof n ? Math.pow(2, (n - 69) / 12) * t : null
      );
    },
    K = function(n) {
      return L(n).freq || J(n);
    ...
    xn = function(n) {
      ...
      return (
        (r.step = On(r.num)),
        (r.type = "PMMPPMM"[r.step]),
        "M" === r.type && "P" === r.q
          ? An
          : ((r.name = "" + r.num + r.q),
            (r.dir = r.num < 0 ? -1 : 1),
            (r.simple =
              8 === r.num || -8 === r.num ? r.num : r.dir * (r.step + 1)),
            (r.alt = jn(r.type, r.q)),
            (r.oct = Math.floor((Math.abs(r.num) - 1) / 7)),
            (r.semitones = r.dir * (dn[r.step] + r.alt + 12 * r.oct)),
            (r.chroma = (((r.dir * (dn[r.step] + r.alt)) % 12) + 12) % 12),
            Object.freeze(r))
      );
    },
    _n = {},
    ...
    wn = function(n) {
      return (
        "string" == typeof n && (n = M(n).chroma),
        "number" == typeof n ? pn[n % 12] : null
      );
    },
    Dn = function(n) {
      void 0 === n && (n = {});
    ...
    Cn = function(n) {
      ...
      return Dn({ step: r, alt: e, oct: t.oct, dir: t.dir });
    },
    Fn = [1, 2, 2, 3, 3, 4, 5, 5, 6, 6, 7, 7],
    Gn = "P m M m M P d P m M m M".split(" "),
    In = function(n) {
      var t = n < 0 ? -1 : 1,
        r = Math.abs(n),
        e = r % 12,
        m = Math.floor(r / 12);
      return t * (Fn[e] + 7 * m) + Gn[e];
    },
    Tn = Object.freeze({
      names: hn,
      tokenize: vn,
    ...
    Un = function(n, t, r) {
      ...
      return void 0 === t
        ? { step: e, alt: m, dir: r }
        : { step: e, alt: m, oct: t + 4 * m + Nn[e], dir: r };
    },
    Hn = function(n, t) {
      return (
        void 0 === t && (t = {}),
    ...
    ft = (function(n, t) {
      ...
      var t = Mt(n);
      if (!t) return st;
      var r = { intervals: t, name: n };
      return (
        (r.chroma = A(t)),
        (r.setnum = parseInt(r.chroma, 2)),
        (r.names = Mt.names(r.chroma)),
        Object.freeze(r)
      );
    }, {}),
    dt = Mt.names,
